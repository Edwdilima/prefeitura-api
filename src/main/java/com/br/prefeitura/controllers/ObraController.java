...
public class ObraController {
    ...
    public ResponseEntity<Obra> salvar(@PathVariable Long licitacao_id, @PathVariable Long usuario_id,
                                       @PathVariable Long secretaria_id, @Valid @RequestBody ObraDTO obraDTO){
        Obra obra = obraService.salvar(licitacao_id, usuario_id, secretaria_id,obraDTO);
