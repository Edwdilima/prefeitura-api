...
public class SecretariaController {
    ...
    public ResponseEntity<Licitacao> criarLicitacao(@PathVariable Long usuarioId, @PathVariable Long secretariaId,  @Valid @RequestBody LicitacaoDTO licitacaoDTO){
        Licitacao novaLicitacao = secretariaService.abrirLicitacao(usuarioId, secretariaId, licitacaoDTO);
